  ...
  return (
    <div>
      {kayttaja ? (
        <div>
          ...
          <Router>
            <Paper square style={{ width: "500px", margin: "0 auto" }}>
              ...
              >
                <Link to="/">
                  <Tab label="Tehtävät" style={{ margin: "0 auto" }} />
                </Link>
                <Link to="/lomake">
                  <Tab label="Lisää tehtävä" style={{ margin: "0 auto" }} />
                </Link>
                <Link to="/">
                  <Tab
            ...
            <Switch>
              ...
              <Route
                path="/lomake"
                render={() => (
                  <TehtavaLomake tehtava={tehtava} setTehtava={setTehtava} />
                )}
              />
            </Switch>
          </Router>
        ...
        <div>
          <SisaankirjautumisLomake setKayttaja={setKayttaja} />
        </div>
      )}
    </div>
  );
